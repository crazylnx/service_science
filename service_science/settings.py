"""
Django settings for service_science project.
...
SECRET_KEY = '!0(4s&du4@)!s-s#76x%5^s6!1reiyyoamr8+zr5gcebn5u7+n'
...
ROOT_URLCONF = 'service_science.urls'
...
WSGI_APPLICATION = 'service_science.wsgi.application'
